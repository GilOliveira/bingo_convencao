...
def main():
    ...
    words = ["Inerências", "Verdadeiramente liberal", "Burocracia", "Isso é socialista!",
             ...
             "Melancia azul", "Liberalómetro", "WOKE", "Estou mesmo a terminar... (não termina)", "BOM DIA LIBERAIS",
              "3 minutos não chega...", "Camaradas...", "Oposição",
            ...
            "Nepotismo", "Asua não ter lido a moção", "Também não concordo com tudo", "Referência soviética/marxista",
            ...
            'Eu não gosto do termo "alas"', "Seguidismo", "Liberais clássicos", "Aportar",
            "O Iniciativa Liberal", "Liberais expulsos",  "Tem medo de aparecer no RAP", "Pujante",
            "Feedback do microfone rebenta tímpanos", "Bronca sobre candidatos às presidenciais", "Analogia futebolística",
            "Acelera(r)", "Não te estamos a ouvir", "Cartazes das Europeias", "Não querem debater",
            "Tiques socialistas", "Foge à ordem de trabalhos", "Ímpeto reformista", "Alcobaça", "DeepSeek/ChatGPT", "Ana Margarida manda boca",
            "Referência ao apelido da Mariana Leitão", "Lista única", "Coletivismos"]
